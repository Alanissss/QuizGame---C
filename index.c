...
int main (){
    ...
    int point01, point02, point03, point04, point05, point06, point07,point010;
    ...
    if( i == 7){
        printf("1) Which one is the first search engine in inteernet?\n\n");
        printf("1) Google\n");
        printf("2) Archie\n");
        printf("3) Wais\n");
        printf("4) Altavista\n");
